...
const addBannersItem = () => {
  ...
  newBannersItem.innerHTML = `
     <div type="button" class="banners__image">
        ...
        />
        <input type="file" onchange="handleFileSelected(event)" class="file-input"/>
        <i class="tag-close">
    ...
    <div class="input input--general banners__input">
      ...
      <input class="" id="shops__name" value="" type="text" required/>
    </div>
  `;
